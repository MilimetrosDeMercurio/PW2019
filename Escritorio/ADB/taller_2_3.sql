...
drop table anio; ----cambiando a smallint

create table anio(
	id_num_anio smallint not null,
...
drop table otorga; ---cambiando a smallint
...
drop table docente; ----cambiando a smallint
...
drop table estudia; ----cambiando a smallint
...
drop table matricula; ---cambiando a smallint
...
create table seccion(
    in_nivel_grado varchar(10),
    num_grado varchar(10)
    letra varchar(10), 
    id_aulaxseccion varchar(30),
    id_aulaxasignatura varchar(30),

    constraint pk_id_seccion primary key(id_nivel_grado,num_grado,letra),
...
drop table semestre; ----cambiando a smallint

create table semestre(
    denominacion varchar(30) not null,
    id_num_anio smallint,

    constraint pk_denominacion primary key(denominacion,id_num_anio),
...
create table asigna(
    id_clase varchar(30),
    num_grado_aulaxseccion varchar(30),
    id_nivel_grado_aulaxseccion varchar(30),
    id_anio_num_aulaxseccion smallint,
    letra_aulaxseccion varchar(10),
    
    constraint pk_asigna primary key (id_clase,num_grado_aulaxseccion,id_nivel_grado_aulaxseccion,id_anio_num_aulaxseccion,letra_aulaxseccion),

    constraint fk_asigna_edificio foreign key (id_clase) references clase 
    (denominacion_edificio) on delete cascade on update cascade,

    constraint fk_asigna_aulaxseccion foreign key (num_grado_aulaxseccion,id_nivel_grado_aulaxseccion,id_anio_num_aulaxseccion,letra_aulaxseccion) references 
    aulaxseccion (num_grado,id_nivel_grado,id_anio_num,letra) on delete cascade on update cascade
...
drop table responsable_SD; ---cambiando a smallint
...
create table responsable_SD(
    ...
    constraint pk_responsable_SD primary key (id_docente,num_grado,id_nivel_grado,letra,denominacion),

    constraint fk_respnsable_SD_docente foreign key (id_docente) references 
    docente (id_docente) on delete cascade on update cascade,

    constraint fk_responsable_SD_nivel foreign key (num_grado,id_nivel_grado,letra) references
    seccion (num_grado,id_nivel_grado,letra) on delete cascade on update cascade,

    constraint fk_responsable_SD_semestre foreign key (denominacion,id_num_anio)
    references semestre (denominacion,id_num_anio) on delete cascade on update cascade
);

drop table aulaxseccion;

drop table aulaxseccion; ---cambiando a smallint

create table aulaxseccion(
    num_grado varchar(30),
    id_nivel_grado varchar(30),
    id_anio_num smallint,
    letra varchar(10), 
...
drop table asigna_AAC; ----cambiando a smallint
...
create table asigna_AAC(
    ...
    constraint pk_asigna_AAC primary key (id_anio_num,letra,id_nivel_grado,
    num_grado,denominacion_edificio),

    constraint fk_asigna_AAC_anio foreign key (id_anio_num) references
    anio (id_num_anio) on delete cascade on update cascade,
    
    constraint fk_asigna_AAC_letra foreign key (letra,
    num_grado,id_nivel_grado) references seccion (letra,
    num_grado,id_nivel_grado) on delete cascade on update cascade,

    constraint fk_asigna_AAC_grado foreign key (id_nivel_grado,num_grado) references 
    grado (id_nivel,num) on delete cascade on update cascade,
